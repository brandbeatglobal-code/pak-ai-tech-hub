/**
 * ISO 3166-1 country names and alpha-2 codes, for the /contact form's country
 * select.
 *
 * Reference data, not marketing copy — that is why it lives here rather than in
 * site-copy.ts. Generated once from Node's ICU data (`Intl.DisplayNames`) and
 * committed, so the list cannot shift between environments or Node versions.
 *
 * Sorted by English name. Regenerate rather than hand-editing.
 */
